   ...
   */
   public Telephone()
   {
      ...
      speakerPanel.add(new JLabel("Speaker:"),
        BorderLayout.NORTH);
      speakerField = new JTextArea(10, 50);
      
      /**
       * Here need Scroll bar
       * 
       * Add JTextArea in the JScrollPanel
       */
     
      JScrollPane SpeakerScroll = new JScrollPane(speakerField);
      SpeakerScroll.setVerticalScrollBarPolicy(ScrollPaneConstants.VERTICAL_SCROLLBAR_ALWAYS);
     
  //Add Textarea in to middle panel
      speakerPanel.add(SpeakerScroll,// Here SpeakerScoll is added to the JPanel
    	         BorderLayout.CENTER);
      ...
      JScrollPane MicrophoneScroll = new JScrollPane(microphoneField);
      MicrophoneScroll.setVerticalScrollBarPolicy(ScrollPaneConstants.VERTICAL_SCROLLBAR_ALWAYS);
      ...
      microphonePanel.add(new JLabel("Microphone:"),
         BorderLayout.NORTH);
      microphonePanel.add(MicrophoneScroll,//Here MicrophoneScroll is added to the Jpanel
         BorderLayout.CENTER);
